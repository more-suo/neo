...
type 
  TestArithmeticOperators = class(patest.TestCase)
    public
      ...
      procedure test_add_4;
      begin      
        var ndarray_0_shape: array of integer := (8, 4, 2);
        var ndarray_0 := neo.arange(64).reshape(ndarray_0_shape);
        var ndarray_1_shape: array of integer := (4, 2);
        var ndarray_1 := neo.arange(64).reshape(ndarray_1_shape);
        
        var res := ndarray_0 + ndarray_1;
        var f := System.IO.File.Open('./neo.Test/test_add_4.neo', System.IO.FileMode.Open);
        var true_res := neo.ndarray.load(new System.IO.BinaryReader(f));
        f.Close;
      ...
      begin      
        ...
        var res := ndarray_0 - ndarray_1;
        var f := System.IO.File.Open('./neo.Test/test_sub_4.neo', System.IO.FileMode.Open);
        var true_res := neo.ndarray.load(new System.IO.BinaryReader(f));
        f.Close;
      ...
      begin      
        ...
        var res := ndarray_0 * ndarray_1;
        var f := System.IO.File.Open('./neo.Test/test_mul_0.neo', System.IO.FileMode.Open);
        var true_res := neo.ndarray.load(new System.IO.BinaryReader(f));
        f.Close;
      ...
      begin      
        ...
        var res := ndarray_0 * ndarray_1;
        var f := System.IO.File.Open('./neo.Test/test_mul_1.neo', System.IO.FileMode.Open);
        var true_res := neo.ndarray.load(new System.IO.BinaryReader(f));
        f.Close;
      ...
      begin      
        ...
        var res := ndarray_0 * ndarray_1;
        var f := System.IO.File.Open('./neo.Test/test_mul_2.neo', System.IO.FileMode.Open);
        var true_res := neo.ndarray.load(new System.IO.BinaryReader(f));
        f.Close;
      ...
      procedure test_mul_3;
      begin
        self.assertRaises&<System.ArithmeticException>(_test_mul_3_helper);
      end;
            
      procedure test_mul_4;
      begin      
        var ndarray_0_shape: array of integer := (8, 4, 2);
        var ndarray_0 := neo.arange(64).reshape(ndarray_0_shape);
        var ndarray_1_shape: array of integer := (4, 2);
        ...
        var res := ndarray_0 * ndarray_1;
        var f := System.IO.File.Open('./neo.Test/test_mul_4.neo', System.IO.FileMode.Open);
        var true_res := neo.ndarray.load(new System.IO.BinaryReader(f));
        f.Close;
